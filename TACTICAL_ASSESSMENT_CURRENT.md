...
- **Action:** IMMEDIATE PRIORITY. Refactor to only update DOM when thread data _actually changes_.
...
- **Action:** Implement true Stale-While-Revalidate logic: serve from cache _and_ update cache from network in background.
